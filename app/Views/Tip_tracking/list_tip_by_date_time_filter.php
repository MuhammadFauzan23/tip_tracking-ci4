                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-3" style="text-align: right;">
                                ...
                                <form action="<?= base_url('Tip/viewListTipbydatetime') ?>" method="GET">
                                    <div class="input-group">
                                        <select class="form-control" name="driver_option" id="driver">
                                        ...
                                        <?php foreach ($data_per_hari_bulan_tahun as $list) : ?>
                                            <input type="text" name="date" value="<?= $list['tgl'] ?>" hidden>
                                        <?php endforeach; ?>
